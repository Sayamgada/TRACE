...
class TransactionFrequencyRuleEvaluatorTest {
    ...
    void shouldNotTriggerWhenTransactionCountEqualsThreshold() {
        ...
        Transaction transaction = transaction(evaluationTime);
    ...
    @Test
    void shouldTriggerWhenCurrentTransactionMakesCountExceedThreshold() {
        Instant evaluationTime =
                Instant.parse("2026-09-05T10:00:00Z");
    ...
    @Test
    void shouldTriggerWhenHistoricalTransactionCountExceedsThreshold() {
        Instant evaluationTime =
                Instant.parse("2026-09-05T10:00:00Z");
    ...
    void shouldIgnoreTransactionsOutsideTwoMinuteWindow() {
        ...
        List<Instant> recentTransactions = List.of(
                ...
                evaluationTime.minusSeconds(180)
        );
    ...
    private Transaction transaction(Instant createdAt) {
